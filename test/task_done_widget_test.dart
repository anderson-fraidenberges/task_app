    ...
    return tester.pumpWidget(
      MultiProvider(
        ...
        child: const MaterialApp(
          home: Scaffold(body: TaskDoneWidget()),
        ),
      ),
    );
  }

  group('Task Done Widget', () {
    setUp(() async {
      await setUpTestHive();
    ...
    testWidgets('Task done text', (WidgetTester tester) async {      
      await pumpWidget(tester);

      expect(find.text('No done tasks.'), findsOneWidget);
    });
  });
}
